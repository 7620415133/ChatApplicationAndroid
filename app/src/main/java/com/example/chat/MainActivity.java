...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        adapterMainChat = new ArrayAdapter<String>(context, R.layout.activity_chatutil);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
       /* switch (item.getItemId()) {
            case R.id.menu_scan_device:
               // findViewById(R.id.menu_search_devices);
                checkPermissions();
                return true;
                break;
            case R.id.menu_enable_bluetooth:
                //findViewById(R.id.menu_enable_bluetooth);
                 enableBluetooth();
                return true;
